...
const sortColumn = ref<'idSubDivisionNv_4' | 'nom' | 'designation' | 'idSubDivisionNv_3'>('nom')
...
function toggleSort(column: 'idSubDivisionNv_4' | 'nom' | 'designation' | 'idSubDivisionNv_3') {
