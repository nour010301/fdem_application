  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { requiresAuth: true, title: 'Produits' },
      },
      {
        path: '/type_produit',
        name: 'typr_produit',
        component: TypeProduitView,
        meta: { requiresAuth: true, title: 'Types Produits' },
      },
      {
        path: '/sections',
        name: 'sections',
        component: SectionView,
        meta: { requiresAuth: true, title: 'Sections de produits' },
      },
      {
        path: '/structures',
        name: 'structures',
        component: StructuresView,
        meta: { requiresAuth: true, title: 'Structures Fond Documentaire' },
      },
      {
        path: '/subdivisions_niv1',
        name: 'subdivisions_niv1',
        component: SubDivisionNv_1View,
        meta: { requiresAuth: true, title: 'Classes de documents' },
      },
      {
        path: '/subdivisions_niv2',
        name: 'subdivisions_niv2',
        component: SubDivisionNv_2View,
        meta: { requiresAuth: true, title: 'Type de documents' },
      },
      {
        path: '/subdivisions_niv3',
        name: 'subdivisions_niv3',
        component: SubDivisionNv_3View,
        meta: { requiresAuth: true, title: 'Documents cibles' },
      },
      {
